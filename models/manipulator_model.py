...
class ManiuplatorModel:
    def __init__(self, Tp):
        ...
        self.alfa = (self.m1 * ((self.l1 / 2) ** 2)) + self.I_1 + (self.m2 * ((self.l1 ** 2) + ((self.l2 / 2) ** 2))) + self.I_2
    ...
    def M(self, x):
        ...
        M = np.array([[self.alfa + (2 * self.beta * np.cos(q2)), self.gamma + (self.beta * np.cos(q2))],
